...
const Input = (props: InputProps) => {
  ...
  if (
    ...
    inputElement = (
      <textarea
        className={clsx(
          "border:black delay-50 h-15 w-full resize-none rounded-xl border-[2px] border-white/10 bg-primaryLight p-2 text-sm tracking-wider text-white outline-0 transition-all placeholder:text-gray-700 hover:border-[#1E88E5]/40 focus:border-[#1E88E5] sm:h-20 md:text-lg",
          disabled && " cursor-not-allowed hover:border-white/10",
          left && "md:rounded-l-none",
    ...
    inputElement = (
      <input
        className={clsx(
          "border:black delay-50 w-full rounded-xl bg-primaryLight py-1 text-sm tracking-wider text-secondary outline-0 transition-all placeholder:text-gray-700 hover:border-[#1E88E5]/40 focus:border-[#1E88E5] sm:py-3 md:text-lg",
  ...
  return (
    <div
      className={clsx(
        `items-left z-5 flex h-fit w-full flex-col rounded-xl font-mono text-lg text-white/75 shadow-xl md:flex-row md:items-center md:bg-secondary`,
