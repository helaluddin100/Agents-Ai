    ...
    <>
      <div
        ...
        className={clsx(
          ...
          "z-30 m-0 flex h-screen w-72 flex-col justify-between bg-primaryLight p-3 font-mono text-black shadow-3xl transition-all",
          "fixed top-0 "
        )}
      >
        <Link
        ...
        >
          ...
          <p className="ml-4 text-xl font-semibold md:text-2xl">Agents.ai</p>
        </Link>
          ...
          <div className="mb-2 flex justify-center gap-2">
            ...
            <button
              className={clsx(
                ...
                "absolute right-0 top-2 z-40 rounded-md bg-secondary p-2 text-white transition-all hover:bg-primary "
              )}
